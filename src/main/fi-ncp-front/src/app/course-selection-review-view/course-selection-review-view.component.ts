...
export class CourseSelectionReviewViewComponent implements OnInit {
  ...
  constructor(private httpClient: HttpClient) {
    ...
    const url = 'http://localhost:9001/test/ncp_review/?sessionId=1234&returnUrl=234123&unique-id=urn:mace:terena.org:schac:personalUniqueID:fi:FIC:180766-2213&SHIB_funetEduPersonLearnerId=1.2.246.562.24.17488477125&SHIB_schacHomeOrganization=oamk.fi&SHIB_schacHomeOrganizationId=02536';
