...
public final class DateConverter {
  ...
  public static String convertXmlGregorianCalendarToString(XMLGregorianCalendar date,
      String formatStr) {
  ...
  public static XMLGregorianCalendar convertStringToXmlGregorianCalendar(String dateStr,
      String formatStr) throws DatatypeConfigurationException, ParseException {
...
//        return DatatypeFactory.newInstance().newXMLGregorianCalendar(c);
  ...
  public static XMLGregorianCalendar convertLocalDateToXmlGregorianCalendar(LocalDate date)
      throws DatatypeConfigurationException {
    return DatatypeFactory.newInstance()
